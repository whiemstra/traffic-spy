...
class URLTest < Minitest::Test
  ...
  def setup
    ...
    @payload_6 = 'payload={"url":"http://turing.io/program","requestedAt":"2013-02-15 21:38:28 -0700","respondedIn":40,"referredBy":"http://turing.com","requestType":"GET","parameters":[],"eventName": "checking_it_out","userAgent":"Mozilla/5.0 (Macintosh%3B Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17","resolutionWidth":"120","resolutionHeight":"160","ip":"77.730.38.594"}'
